 ...
 * @author Sarabusab
 */
public class Permu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (inputuser < inputuserr){
            ...
            for (int i = 1; i <= inputuser; i++) {                      // FOR LOOP PROCESS
               firstfac = firstfac.multiply(BigInteger.valueOf(i));     // BigInteger.valueOf FUNCTION NEEDED
             }
            
            
            // PERMUTATION PROCESS WITH SECOND FACTORIAL INPUT (below)

            // SUBTRACTION FOR FORMULA OF PERMUTATION
            int permutotal = inputuser - inputuserr;                    // DEDUCTION PROCESS
            
            // DECLARATION
            BigInteger secondfac = new BigInteger("1");
            for (int i = 1; i <= permutotal; i++) {                     // FOR LOOP PROCESS
               secondfac = secondfac.multiply(BigInteger.valueOf(i));   // FACTORIAL RESULT SENDS TO "permuprocess"
            }
            
            
            // DECLARATION WITH DIVISION FUNCTION USING BIGINTEGER
            BigInteger division;
            division = firstfac.divide(secondfac);
            
            // SETTING LABELS FOR THE FORMULA
            jLabel9.setText(inputuser + "!");
            jLabel10.setText("( " + inputuser + " - " + inputuserr + ")!");
            
            // SHOW OUTPUT
            JOptionPane.showMessageDialog(null, "Permutation of " + inputuser + " and " + inputuserr + " is: " + division);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TRANSFER WINDOW
        dispose();
        PermuRepe transferpermu = new PermuRepe();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Permu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
